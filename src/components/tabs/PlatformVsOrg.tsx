...
export default function PlatformVsOrg({ onNavigate }: PlatformVsOrgProps) {
  return (
    <div className="section active" id="section-platformorg">
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginBottom: '2rem' }}>
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '8px', overflow: 'hidden' }}>
          <div style={{ padding: '0.875rem 1.25rem', borderBottom: '2px solid var(--accent-blue)', background: 'var(--surface2)' }}>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.625rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--accent-blue)' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: '8px', overflow: 'hidden' }}>
          <div style={{ padding: '0.875rem 1.25rem', borderBottom: '2px solid var(--accent-amber)', background: 'var(--surface2)' }}>
            <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.625rem', textTransform: 'uppercase', letterSpacing: '0.1em', color: 'var(--accent-amber)' }}>
      ...
      <ScalabilitySection data={scalabilitySections.platformorg} onNavigate={onNavigate} />
    </div>
  )
}
