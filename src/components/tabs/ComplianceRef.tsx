...
const frameworks: FrameworkCard[] = [
  {
    ...
    statusLabel: 'In force — further deadlines approved',
  ...
  return (
    <div className="section active" id="section-compliance">
      ...
      <div className="callout">
        Regulations and obligations below are summarised for architectural decision-making from a governance design lens within EU context. They are not legal advice.<br /> Last updated: September, 10th 2026.<br />For latest regulatory developments please refer to{' '}
      ...
      <ScalabilitySection data={scalabilitySections.compliance} onNavigate={onNavigate} />
    </div>
  )
}
