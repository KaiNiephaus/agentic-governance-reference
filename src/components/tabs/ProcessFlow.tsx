...
export default function ProcessFlow({ onNavigate }: ProcessFlowProps) {
  ...
  return (
    <div className="section active" id="section-flow">
      ...
      <ScalabilitySection data={scalabilitySections.flow} onNavigate={onNavigate} />
    </div>
  )
}
